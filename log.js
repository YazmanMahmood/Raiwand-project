...
document.addEventListener('DOMContentLoaded', () => {
    const elements = {
        ...
        setValuesButton: document.getElementById('set-values-button')
    };
    ...
    // Handle set values button click
    if (elements.setValuesButton) {
        elements.setValuesButton.addEventListener('click', (event) => {
            event.preventDefault();
            window.location.href = 'log2.html';
        });
    } else {
        console.error('Set values button not found');
    }
