...
// Initialize Chart.js for daily summary (dummy data)
...
// Create gauges (dummy initialization)
...
database.ref('ESP1/ESP_20240622030452').on('value', updateData);
...
function toggleWater() {
  ...
  firebase.database().ref('ESP1/ESP_20240622030452').update({ waterState });
}
